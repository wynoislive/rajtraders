      ...
      <aside className={cx('fixed inset-y-0 left-0 z-40 flex w-[252px] flex-col border-r border-[hsl(var(--sidebar-border))] bg-[hsl(var(--sidebar))] px-4 py-5 text-[hsl(var(--sidebar-foreground))] transition-transform duration-300 lg:static lg:translate-x-0', mobileNav ? 'translate-x-0' : '-translate-x-full')}>
        <div className="flex items-center justify-between px-3">
          <Link href="/" className="flex items-center gap-3" data-testid="link-brand">
            <div className="flex size-9 items-center justify-center rounded-xl bg-[hsl(var(--sidebar-primary))] text-[hsl(var(--sidebar-primary-foreground))]"><ShoppingBag size={19} strokeWidth={2.5} /></div>
...
// ─── Public Web Storefront & Product Detail Component ─────
...
function PublicStorefront() {
  ...
  const [discountResult] = useState<any>(null);
  ...
  const handleCheckPincode = async (targetPin: string) => {
    if (!/^[1-9][0-9]{5}$/.test(targetPin.trim())) {
    ...
    try {
      ...
      setPincodeResult({ allowed: true, pincode: targetPin, city: 'India', message: `Delivery available to ${targetPin}` });
  ...
  return (
    <div className="min-h-screen bg-[#F7F2EA] text-[#0E3D42] font-sans">
      ...
      <div className="bg-[#0E3D42] text-white text-xs py-2 px-4 flex items-center justify-between shadow-sm cursor-pointer" onClick={() => setShowPincodeModal(true)}>
      ...
      {/* Main Store Header */}
      <header className="sticky top-0 z-30 bg-white border-b border-[#0E3D42]/10 backdrop-blur-md bg-white/90 px-4 sm:px-8 py-3.5">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[10px] font-bold uppercase tracking-widest text-[#0E3D42]/60">Gourmet Bakery & Artisanal Products</div>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <div className="flex items-center gap-3">
                <span className="text-xs font-bold hidden sm:inline">Hi, {user.firstName}!</span>
            ...
            <Link href="/admin" className="hidden lg:inline-flex items-center gap-1.5 text-xs font-bold text-[#0E3D42]/60 hover:text-[#0E3D42] ml-2">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 py-8">
        {currentProduct ? (
          ...
          <div className="space-y-8">
            <Link href="/" className="inline-flex items-center gap-2 text-xs font-bold text-[#0E3D42]/70 hover:text-[#0E3D42] bg-white px-3 py-1.5 rounded-lg border border-[#0E3D42]/10">
              ← Back to Catalog
            </Link>
            ...
            <div className="grid md:grid-cols-2 gap-10 bg-white p-6 sm:p-10 rounded-3xl border border-[#0E3D42]/10 shadow-xl">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-[#EFE8DC] aspect-square flex items-center justify-center">
                ...
                <span className="absolute bottom-4 left-4 bg-black/70 text-white text-xs px-3 py-1 rounded-full font-semibold">
              ...
              <div className="flex flex-col justify-between space-y-6">
                ...
                <div className="bg-[#F7F2EA] p-4 rounded-2xl border border-[#0E3D42]/10 space-y-3">
                  ...
                  {pincodeResult && (
                    <div className={cx('text-xs font-bold p-2.5 rounded-xl flex items-center gap-2', pincodeResult.allowed ? 'bg-emerald-100 text-emerald-800' : 'bg-red-100 text-red-800')}>
                      <CheckCircle2 size={16} />
          ...
          <div className="space-y-8">
            <div className="text-center max-w-2xl mx-auto space-y-2">
              ...
              <p className="text-sm font-medium text-[#0E3D42]/70">Small-batch artisanal cakes, organic bakes & specialty store items.</p>
            </div>
